        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            ...
            <div className="flex flex-col gap-5 ">
              <div className="flex gap-2 md:gap-3">
                ...
                <div className="p-medium-16 lg:p-regular-20 flex flex-wrap">
                  ...
                  <p className="ml-1">
                    {formatDateTime(event?.endDateTime).timeOnly} - {" "}{formatDateTime(event?.endDateTime).timeOnly} 
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="p-medium-26 lg-p-regular-18">{event?.description}</p>
              <p className="p-medium-26 lg-p-regular-18 truncate text-primary-500 underline">{event?.url}</p>
            </div>
          </div>
        </div>
      </section>
